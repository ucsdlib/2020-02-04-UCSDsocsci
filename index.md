...
venue: "UC San Diego Library - Data Carpentry R for Social Science"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Stephanie Labou (Library), Reid Otsuji (Library), Rick Mccosh (OBGYN/Reprod Sci), Justin Shaffer (Pediatrics)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
